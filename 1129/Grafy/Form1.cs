...
namespace Grafy
{
    public partial class Form1 : Form
    {
        ...
        //4. Wezel3 Nastepnie(Wezel3 w) - nastepny po, np po 1 2
        //  1) gdy jest prawe dziecko, to uzyj funkcji znajdzMin(w.dzieckoPrawe))
