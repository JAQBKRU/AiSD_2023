...
namespace Grafy
{
    public partial class Form1 : Form
    {
        ...
        public class DrzewoBinarne
        {
            ...
            private Wezel3 ZnajdzMin(Wezel3 w)
            {
            ...
            private Wezel3 ZnajdzMax(Wezel3 w)
            {
                if (w.praweDziecko != null)
                {
            ...
            private Wezel3 Nastepnik(Wezel3 w)
            {
            ...
            private Wezel3 UsunGdy2Dzieci(Wezel3 w)
            {
                ...
                //zamiennik.rodzic = w.rodzic;//obojetnie czy tu, czy wyzej
                w.rodzic = null;

                //dodaj przewiazanie z w L i P
                //return w;
            }
            //kod z cw
        }
