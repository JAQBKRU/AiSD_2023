    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            */
            ...
            MessageBox.Show(drzewoRozpinajace.listaWezlow[0].listaKrawedzi.Count().ToString());
                            ...
                            foreach (var g in listaGrafow)
                            {
                                foreach (var wezel in g.listaWezlow)
                                {
                                    ...
                                    if (aktualnyWierzcholek.wartosc == wezel.wartosc)
                                    {
                                        ...
                                        //g.listaWezlow.Add(krawedz.koniec);//new WezelKruskal ??? - naprawi blad
                                        g.listaWezlow.Add(new WezelKruskal(krawedz.koniec.wartosc));//new WezelKruskal ??? - naprawi blad
                                        break;
                                    }
                                    ...
                                    {
                                        g.listaKrawedzi.Add(krawedz);
                                        //g.listaWezlow.Add(krawedz.poczatek);//new WezelKruskal ??? - naprawi blad
                                        g.listaWezlow.Add(new WezelKruskal(krawedz.poczatek.wartosc));//new WezelKruskal ??? - naprawi blad
                                        break;
                                    }
                                }
                            }
